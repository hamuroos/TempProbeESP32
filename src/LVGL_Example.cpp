...
void IRAM_ATTR Temp_Read(lv_timer_t * t){
  ...
  if(!stop_reading){
    ...
    if (stableCount >= stableReadings) {
      ...
      JsonDoc["plant"] = "further2";
      JsonDoc["plant_id"] = "4117";
      JsonDoc["factory"] = "00000000000000";
      JsonDoc["machine_type"] = "handheld_temp";
      JsonDoc["machine_name"] = "probe_01";
      JsonDoc["area"] = "cooling";
      JsonDoc["line"] = "Line7";
      JsonDoc["product_name"] = "Unknow";
      JsonDoc["shift"] = "D";
      JsonDoc["batch_no"] = 10;
...
static void event_handler_Start_btn(lv_event_t * e) {
  if (lv_obj_has_state(Start_btn, LV_STATE_CHECKED)) { // Button is in "On" state 
    printf("Button is On\n");
    stop_reading = false;
